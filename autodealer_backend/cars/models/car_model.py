...
class CarModel(models.Model):
    ...
    production_end = models.PositiveIntegerField(
        null=True,
        blank=True,
        validators=[MinValueValidator(1900), MaxValueValidator(2100)],
    )
    ...
    drive_type = models.CharField(max_length=20, choices=DRIVE_TYPES, default="fwd")
    fuel_consumption = models.DecimalField(max_digits=4, decimal_places=1, default=8.5)
